...
$siteService       = new SiteService($siteRepo, $adminRepo);
$terrainService    = new TerrainService($terrainRepo, $siteRepo, $adminRepo);
$membreService     = new MembreService($membreRepo, $siteRepo, $adminRepo);
...
$horaireService        = new HoraireSiteService($horaireRepo, $adminRepo);
...
$reservationService    = new ReservationService($reservationRepo, $terrainRepo, $membreRepo, $inscriptionRepo, $adminRepo, $horaireRepo, $fermetureRepo, $penaliteRepo, $pdo);
