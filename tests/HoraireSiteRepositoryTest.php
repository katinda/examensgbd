...
class HoraireSiteRepositoryTest extends TestCase {
    ...
    public function testFindByIdRetourneLeBonHoraire(): void { $horaire = $this->repository->findById(1); $this->assertNotNull($horaire); $this->assertEquals('08:00:00', $horaire->getHeureDebut()); }
}
