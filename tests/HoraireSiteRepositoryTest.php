...
class HoraireSiteRepositoryTest extends TestCase {
    ...
    public function testFindBySiteIdRetourneLesHorairesDuSite(): void { $horaires = $this->repository->findBySiteId(1); $this->assertCount(1, $horaires); $this->assertEquals(2026, $horaires[0]->getAnnee()); }
}
