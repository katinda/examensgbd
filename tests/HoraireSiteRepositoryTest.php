...
class HoraireSiteRepositoryTest extends TestCase {
    ...
    public function testFindBySiteAndAnneeRetourneLeBonHoraire(): void { $horaire = $this->repository->findBySiteAndAnnee(1, 2026); $this->assertNotNull($horaire); $this->assertEquals('08:00:00', $horaire->getHeureDebut()); }
}
