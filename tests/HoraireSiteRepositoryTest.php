...
class HoraireSiteRepositoryTest extends TestCase {
    ...
    public function testUpdateModifieUnHoraire(): void { $horaire = $this->repository->findById(1); $horaire->setHeureDebut('10:00:00'); $this->repository->update($horaire); $this->assertEquals('10:00:00', $this->repository->findById(1)->getHeureDebut()); }
}
