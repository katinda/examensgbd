...
class HoraireSiteServiceTest extends TestCase {
    ...
    public function testGetHorairesBySiteIdRetourneLesHoraires(): void { $mockRepo = $this->createStub(HoraireSiteRepository::class); $mockRepo->method('findBySiteId')->willReturn([$this->creerHoraire(1,1,2026,'08:00:00','22:00:00')]); $service = new HoraireSiteService($mockRepo); $this->assertCount(1, $service->getHorairesBySiteId(1)); }
}
