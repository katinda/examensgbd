...
class HoraireSiteServiceTest extends TestCase {
    ...
    public function testCreateHoraireRetourneHeuresInvalides(): void { $mockRepo = $this->createStub(HoraireSiteRepository::class); $service = new HoraireSiteService($mockRepo); $result = $service->createHoraire(['site_id'=>1,'annee'=>2026,'heure_debut'=>'22:00:00','heure_fin'=>'08:00:00']); $this->assertEquals('heures_invalides', $result); }
}
