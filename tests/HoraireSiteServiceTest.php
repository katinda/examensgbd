...
class HoraireSiteServiceTest extends TestCase {
    ...
    public function testUpdateHoraireRetourneFalseSiInexistant(): void { $mockRepo = $this->createStub(HoraireSiteRepository::class); $mockRepo->method('findById')->willReturn(null); $service = new HoraireSiteService($mockRepo); $this->assertFalse($service->updateHoraire(999, ['heure_debut'=>'09:00:00'])); }
}
