...
class HoraireSiteServiceTest extends TestCase {
    ...
    public function testDeleteHoraireRetourneTrueSiExiste(): void { $mockRepo = $this->createStub(HoraireSiteRepository::class); $mockRepo->method('findById')->willReturn($this->creerHoraire(1,1,2026,'08:00:00','22:00:00')); $service = new HoraireSiteService($mockRepo); $this->assertTrue($service->deleteHoraire(1)); }
}
