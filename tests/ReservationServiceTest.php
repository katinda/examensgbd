...
class ReservationServiceTest extends TestCase {
    public function testCreateReservationRetourneTerrainIntrouvable(): void {
        ...
        $result = $service->createReservation(['terrain_id' => 999, 'organisateur_id' => 1, 'date_match' => '2026-05-10', 'heure_debut' => '10:00:00', 'type' => 'PRIVE']);
        $this->assertEquals('terrain_introuvable', $result);
    }
}
