...
class ReservationServiceTest extends TestCase {
    public function testCreateReservationRetourneOrganisateurIntrouvable(): void {
        ...
        $service = new ReservationService($this->createStub(ReservationRepository::class), $mockTerrain, $mockMembre);
        $result = $service->createReservation(['terrain_id' => 1, 'organisateur_id' => 999, 'date_match' => '2026-05-10', 'heure_debut' => '10:00:00', 'type' => 'PRIVE']);
        $this->assertEquals('organisateur_introuvable', $result);
    }
}
