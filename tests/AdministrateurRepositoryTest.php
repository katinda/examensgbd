...
class AdministrateurRepositoryTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        $this->pdo->exec("INSERT INTO Administrateurs (Login, Mot_De_Passe_Hash, Nom, Prenom, Email, Type, Site_ID, Est_Actif) VALUES ('admin.global', 'hash1', 'Dupont', 'Jean', 'jean@padel.fr', 'GLOBAL', NULL, 1), ('admin.paris', 'hash2', 'Martin', 'Alice', 'alice@padel.fr', 'SITE', 1, 1)");
