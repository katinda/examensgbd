...
class PenaliteServiceTest extends TestCase {
    public function testLeverPenaliteRetourneAdminIntrouvable(): void {
        $pr=$this->createStub(PenaliteRepository::class);$pr->method('findById')->willReturn(new Penalite(1,1,null,'2026-05-01','2026-05-15','OTHER',false));$ar=$this->createStub(AdministrateurRepository::class);$ar->method('findById')->willReturn(null);$s=new PenaliteService($pr,$this->createStub(MembreRepository::class),$ar);$this->assertEquals('admin_introuvable',$s->leverPenalite(1,['admin_id'=>999,'raison'=>'t']));
    }
}
