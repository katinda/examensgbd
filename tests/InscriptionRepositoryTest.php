...
class InscriptionRepositoryTest extends TestCase {
    ...
    // Vérifie que findById() retourne l'inscription correspondante
    public function testFindByIdRetourneLInscription(): void {
        $inscription = $this->repository->findById(1);
        $this->assertNotNull($inscription);
        $this->assertTrue($inscription->isEstOrganisateur());
    }


    // Vérifie que findById() retourne null si l'inscription n'existe pas
